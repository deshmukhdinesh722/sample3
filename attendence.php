          ...
          <div class="well bs-component">
            <form class="form-horizontal">
              <fieldset>
                ...
                <p align="center"><big><b>Add Attendence</b></big></p>
                        ...
                        <tr>
                          <td align="center"><a href="view_employee.php?emp_id=<?php echo $row["emp_id"]; ?>" title="Update"><?php echo $row['lname'] ?>,  <?php echo $row['fname'] ?></a></td>
                           <td align="center">
                            ...
                            <a class="btn btn-danger" href="attendence2.php?emp_id=<?php echo $row["emp_id"]; ?>">Add </a>
                          </td>
                        </tr>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select name="division" class="form-control" placeholder="Division" required>
                      ...
                      <option value="Control">Gard</option>
                    </select>
                  </div>
                </div>
