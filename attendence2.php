      ...
      <?php
        ...
        while ($row = mysqli_fetch_assoc($result))
        {
          ...
          ?>
              ...
              <form class="form-horizontal" action="add_attendence.php" method="post" name="form">
                <input type="hidden" name="new" value="1" />
                <input name="id" type="hidden" value="<?php echo $row['emp_id'];?>" />
                  <div class="form-group">
                    <label class="col-sm-5 control-label"></label>
                    <div class="col-sm-4">
                      <h2><?php echo $row['lname']; ?>, <?php   
  $fname=$row['fname']; echo $fname; ?></h2>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-5 control-label">Name :</label>
                    <div class="col-sm-4">
                      <input type="text" name="name"  value="<?php  $fname=$row['fname']; echo $fname; ?>"  class="form-control"  required="required" readonly>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-5 control-label">Add Attendence  :</label>
                    <div class="col-sm-4">
                      <input type="date" name="attendence" class="form-control"  required="required">
                    </div>
                  </div>
                  <div class="form-group" >
                    <label class="col-sm-5 control-label"></label>
                    <div class="col-sm-1">
                      <label class="col-sm-1 control-label">Absent</label><input type="radio" name="ap" class="form-control" value="A" required="required">
                      <label class="col-sm-1 control-label">Present</label><input type="radio" name="ap" class="form-control" value="P" required="required">
                    </div>
                  </div>
                  <br><br>
