...
?>
  <form class="form-horizontal" action="update_password.php" method="post" name="form">
 ...
 <div class="form-group">
              ...
              <form class="form-horizontal" action="update_password.php" method="post" name="form">
                  ...
                  <div class="form-group">
                    <label class="col-sm-5 control-label">Change Password  :</label>
                    <div class="col-sm-4">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      ...
                      <a href="dinesh.php" class="btn btn-primary">Cancel</a>
                    </div>
                  </div><br><br>
        </form>
        ...
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            <div class="modal-header" style="padding:20px 50px;">
              ...
              <h3 align="center">You are logged in as <b><?php echo $_SESSION['fname']; ?></b></h3>
            </div>
